...
const UserInfo = () => {
    return (
        <ul className="mobile:hidden flex-initial">
            <li className="flex flex-around items-center w-40 h-20">
                <a className="px-4" href="/alert">
                    <embed type="image/svg+xml" src="https://lf3-cdn-tos.bytescm.com/obj/static/xitu_juejin_web/c7f91fad712592633383df6aa430c93c.svg" />
                </a>
                <a className="w-10 h-10" href="/profile">
                    <div className="rounded-full bg-cover w-full h-full" style={{backgroundImage: 'url(https://sf3-ttcdn-tos.pstatp.com/img/user-avatar/e85c76d2bdac57930f1135a96c090c83~300x300.image)'}}></div>
                </a>
            </li>
        </ul>
    )
...
const Header = ({ condition, onConditionChange }) => {
    ...
    return (
        <div className="h-20">
            <header className="px-8 mobile:pl-4 fixed inline-flex mx-auto justify-center mobile:justify-start items-start mobile:items-center top-0 border-b w-screen h-20 z-40 bg-white transition-all transform">
                <img
                ...
                <ul className="flex-none flex justify-start items-center h-20 overflow-auto">{
